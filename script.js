// --- FULL TRANSLATION DICTIONARY (Updated with Local Lifeline Keys) ---
const translations = {
    en: {
        // Top Bar
        ...
        // NEW: Local Lifeline Translations (For localLifeline.html)
...
function isAnyModalOpen() {
    ...
    const isDonateOpen = donateModal && donateModal.style.display === 'flex'; // NEW
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // ----------------------------------------------------------------
    // --- Donate Modal Listeners (Refactored and Added) ---
    // ----------------------------------------------------------------
...
function renderContent() {
    ...
    // Use innerHTML for the note because it contains the bolded receiver name
    if (donateNote) donateNote.innerHTML = t.modalDonateNote; 
    
    // Update the Menu Link text (in case it wasn't covered by data-key)
...
function setupMenuLinkClosing() {
    ...
    // AND all dropdown sub-items. Also include the donate button now.
    ...
    linksToCloseMenu.forEach(link => {
        // Ensure that the Tax Calc and Donate buttons do NOT close the menu, 
        // as they trigger a modal instead.
